# ---------------------------------------------------------------------------------------------------------------------
# ROOT CONFIGURATION for the aws/serverless-ai-gallery lab.
#
...
#
# Lab inputs (region, state bucket, domains, GitHub repo, Bedrock model, Pillow layer) come from the
# lab's .env via Task's dotenv, and units read them with get_env(...). See .env.example / README.
# ---------------------------------------------------------------------------------------------------------------------
