...
# Cloud NAT so the private Autopilot nodes get egress (Argo CD's repo-server needs to reach
# github.com to fetch the upstream Argo CD kustomize base and this repo). Sourced from the modules
# repo by pinned tag.
