...
terraform {
  source = "git::https://github.com/gichie534/infrastructure-catalog.git//modules/gcp/workload-identity-federation?ref=gcp-workload-identity-federation-v0.2.0"
}

inputs = {
  project_id        = local.project_id
  pool_id           = "github-ci"
  pool_display_name = "GitHub CI (gke-autopilot-helm)"
  ...
  #   - container.developer     -> get cluster credentials + apply workloads
