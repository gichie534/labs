...
# Cloud NAT so the private Autopilot nodes get egress (Argo CD's repo-server needs github.com;
# the VM charts pull images and Grafana talks to accounts.google.com). Sourced from the modules
# repo by pinned tag.
