...
# Cloud NAT so the private Autopilot nodes get egress (pulling images, reaching AWS STS/SQS over the
# public internet). Sourced from the modules repo by pinned tag.
